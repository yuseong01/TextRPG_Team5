            ...
            normalAtk1.FailDialogue.AddRange(new[]
{
            ...
            // 기본공격 2
            var normalAtk2 = new BossMonster_Skill { Name = "캠 검사", Damage = 10, Type = BossSkillType.Normal };
            ...
            normalAtk2.FailDialogue.AddRange(new[]
{
            ...
            // 기본공격 3
            var normalAtk3 = new BossMonster_Skill { Name = "마이크 검사", Damage = 10, Type = BossSkillType.Normal };
